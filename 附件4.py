        ...
        for i in cnc_sign:
            ...
            if wl[i]==1:
                ...
                if total_time-cnc_time[i]>=cnc_two_one and huai[i]==0 and gongxu[i]==0:
                    aim_made=True
                    finish[i]=1
                elif total_time-cnc_time[i]>=cnc_two_two and huai[i]==0 and gongxu[i]==1:
                    aim_made=True
                    finish[i]=1
                elif huai[i]==1:
                    if rand_tag==False:
                    ...
                    if total_time-huai_time[i]>=last_huai:
                        ...
                        huai[i]=0
                        rand_tag=False
                        print("故障：",work,i,huai_time[i],huai_time[i]+last_huai)
            if cnc_sign[i]==0 :
                                     ...
                                     if wl[i]==0:
                                         ...
                                         if wl_time>=60:
                                             ...
                                             if n[0]>=60:
                                                 ...
                                                 print("{}分{}秒".format(n[0],n[1],n[0],n[1]+rgv_ou),i)
                                         else:
                                             print("{}秒".format(wl_time),i)
            ...
            for i in "cnk_1,cnk_3,cnk_5,cnk_7,cnk_2,cnk_4,cnk_6,cnk_8".split(",")[A:]:
                if total_time-cnc_time[i]>=cnc_two_two and huai[i]==0 and wl[i]==1:
                    if abs(cnc_set[i]-rgv_set)==1:
                            rgv_time=total_time
                            while total_time-rgv_time<rgv_move1:
                                total_time+=1
